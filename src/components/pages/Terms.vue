            ...
            <v-card>
              <v-card-text>
                <v-row>
                  <v-col>
                    <p :class="['pa-4']">
                      この利用規約（以下、「本規約」といいます。）は、はにーま（以下、「管理者」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
                      登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第1条（適用）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第2条（利用登録）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第3条（ユーザーIDおよびパスワードの管理）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第4条（禁止事項）</div>
                    <p :class="['pl-4', 'pb-4']">
                    ...
                    <div :class="['text-h5', 'pa-4']">第5条（本サービスの提供の停止等）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第6条（利用制限および登録抹消）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第7条（保証の否認および免責事項）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第8条（サービス内容の変更等）</div>
                    <p :class="['pl-4']">
                      管理者は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第9条（利用規約の変更）</div>
                    <ol :class="['pl-8']">
                      <li>
                    ...
                    <div :class="['text-h5', 'pa-4']">第11条（個人情報の取扱い）</div>
                    <p :class="['pl-4']">
                      管理者は、本サービスの利用によって取得する個人情報については、管理者「プライバシーポリシー」に従い適切に取り扱うものとします。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第12条（通知または連絡）</div>
                    <p :class="['pl-4']">
                    ...
                    <div :class="['text-h5', 'pa-4']">第13条（権利義務の譲渡の禁止）</div>
                    <p :class="['pl-4']">
                      ユーザーは、管理者の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第15条（準拠法・裁判管轄）</div>
                    <ol :class="['pl-8']">
            ...
            <v-card>
              <v-card-text>
                <v-row>
                  <v-col>
                    <p :class="['pa-4']">
                      はにーま（以下、「管理者」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第1条（登録情報）</div>
                    <p :class="['pl-4']">
                      本サービスでは、メールアドレス、Twitterアカウントデータ、Googleアカウントデータ、及び匿名利用者の発信元アドレスを保持しています。これらの情報はユーザーの識別など、本サービスの機能の範囲において利用されます。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第2条（個人情報の提供）</div>
                    <p :class="['pl-4']">
                      本サービスは、公的機関により法令に基づいた要請があった場合に限り、保持しているデータを第三者に提供します。
                    </p>
                    <div :class="['text-h5', 'pa-4']">第3条（免責事項）</div>
                    <p :class="['pl-4']">本プライバシーポリシーには、利用規約と同様の免責事項が適用されます。</p>
                  </v-col>
                </v-row>
              </v-card-text>
            </v-card>
