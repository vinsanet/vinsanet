<template>
  <v-navigation-drawer :model-value="props.drawer" expand-on-hover :rail="!mobile">
    <v-list nav>
      <v-list-item prepend-icon="mdi-home" title="ホーム" value="home" @click.stop="onClickHome"></v-list-item>
      <v-list-item
        prepend-icon="mdi-file-document"
        title="利用規約"
        value="terms"
        @click.stop="onClickTerms"
      ></v-list-item>
      <v-list-item
        prepend-icon="mdi-help-circle"
        title="よくある質問"
        value="faq"
        @click.stop="onClickFaq"
      ></v-list-item>
      <v-list-item
        prepend-icon="mdi-hand-coin"
        title="開発支援"
        value="support"
        @click.stop="onClickSupport"
      ></v-list-item>
      <v-list-item
